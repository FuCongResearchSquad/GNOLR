"""
DCMT ICDE-2023: https://ieeexplore.ieee.org/abstract/document/10184648
"""
...
class DCMT(nn.Module):
    ...
    def forward(self, data, group=None):
        ...
        # ctr & cvr: [batch_size, num_tasks(ctr, cvr, cvr_n), emb_size]
        user_item_embedding = user_embeddings * item_embeddings

        # logits: [batch_size, num_tasks(ctr, cvr, cvr_n)]
