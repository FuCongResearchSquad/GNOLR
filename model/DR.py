"""
ESCM2-DR SIGIR-2022: https://dl.acm.org/doi/abs/10.1145/3477495.3531972
"""
...
class DR(nn.Module):
    ...
    def forward(self, data, group=None):
        ...
        # ctr & cvr: [batch_size, num_tasks(ctr, cvr, imputation_tower), emb_size]
        user_item_embedding = user_embeddings * item_embeddings

        # logits: [batch_size, num_tasks(ctr, cvr, imputation_tower)]
