...
if [ $# -ne 2 ]; then
    echo "train: ./run.sh cuda:0 false"
    echo "inference: ./run.sh cuda:0 true"
    exit 1
fi
...
# default arguments
DATA_DIR="/GNOLR/data_process/retailrocket"
LOG_DIR="/GNOLR/data_process/retailrocket/log/single-task"
